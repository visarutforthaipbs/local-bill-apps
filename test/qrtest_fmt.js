...
const QR = (function(){
  ...
  function build(v,cw){
    ...
    function placeFmt(mm,mask){const bits=fmtBits(mask);const A=[[8,0],[8,1],[8,2],[8,3],[8,4],[8,5],[8,7],[8,8],[7,8],[5,8],[4,8],[3,8],[2,8],[1,8],[0,8]];const B=[[size-1,8],[size-2,8],[size-3,8],[size-4,8],[size-5,8],[size-6,8],[size-7,8],[8,size-8],[8,size-7],[8,size-6],[8,size-5],[8,size-4],[8,size-3],[8,size-2],[8,size-1]];for(let i=0;i<15;i++){const bit=(bits>>i)&1;const bb=(bits>>(14-i))&1;mm[A[i][0]][A[i][1]]=bb;mm[B[i][0]][B[i][1]]=bb;}}
