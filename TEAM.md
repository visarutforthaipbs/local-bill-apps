...
## Current operating override — 2026-09-23, 2.0.3 containment
...
The owner directed an AI-assisted audit instead of the proposed external Thai
practitioner prerequisite. Record it as that decision, never as professional
approval or legal certification. Technical gates in `DEPLOYMENT.md` remain intact.

Current feature claims must follow the dated `SKU.md` override: ordinary non-VAT
THB full-payment receipts only; income classification free to all tiers; cloud
connect/sync/restore, PIT payable/refund estimates and e-Tax XML paused. Do not use
old "full Thai tax", automatic WHT or multi-device sync promises in new copy.
Pro prices remain ฿599/฿1,900; existing-customer handling remains an owner decision.
Historical roles/sprints below are retained, not evidence of completed channels.
...
- ข้อความสำหรับ 2.0.3 ต้องบอกขอบเขตชัด: ใบเสร็จธรรมดาเต็มจำนวนเป็นเงินบาท ·
  ตรวจการหัก ณ ที่จ่ายก่อนออกใบเสร็จ · สำรองข้อมูลในเครื่อง · AI ช่วยร่างใบเสนอราคา
  ห้ามใช้คำสัญญาเวลา ความถูกต้องทางภาษี หรือซิงก์ที่ยังไม่ได้ตรวจ
...
- ประจำ: ตรวจลิงก์ R2 + SHA-256 ตรงกับ DELIVERY.md · หน้า download ชี้เวอร์ชันล่าสุด ·
  price parity ตาม SKU.md (฿599/฿1,900 ตรงกัน ไม่ใช้กฎเก่า ±฿10) · เดินเรื่อง Phase-2 (key dispenser)
  เมื่อยอดแตะ ~10/วัน
